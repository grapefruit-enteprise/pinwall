...
//                        console.log("line 46 " , currentTag);
//                        var currentTag = tags[i];
//                        db.Tag.findOne({where: {name: currentTag}})
//                            .then(function(tag){
//                                console.log("current tag", currentTag)
//                                if(tag){
//                                    console.log("in if tag not null :", tag)
//                                    console.log("arr of tag ids", tagIdArr);
//                                    tagIdArr.push(tag.id);
//                                } else {
//                                    console.log("else current tag ", currentTag)
//                                    db.Tag.create({name: currentTag})
//                                        .then(function(tag){
//                                            tagIdArr.push(tag.id)
//                                        });// db.Tag.create
//                                }
//
//                            }); // findOneTags
//                    console.log("tag array", tagIdArr)
//                    }
//                    console.log("NotesCategories has been update !!");
//                    noteRecord.setTags(tagIdArr, noteRecord.id)
//                })
//               .then(function(note){
